...
?>
	<table class='consultar_producto' id='consultar_producto_tabla'>
		<thead>
		<tr class='encabezado'>
...
<?php 
		...
		while($row = $res->fetch_assoc())
		{
			...
			echo "<tr class='elim_activo' id='elim_tr_$id'>
					...
					echo "<td class='ancho'><div class='boton_consultar_producto' data-id='$id' data-descripcion='$descripcion'>Seleccionar</div></td>";
			echo "</tr>";
